...
"font: 75 12pt \"Century Gothic\";"));
        ...
        btnExitAddMember = new QPushButton(addmember);
        btnExitAddMember->setObjectName(QString::fromUtf8("btnExitAddMember"));
        btnExitAddMember->setGeometry(QRect(530, 20, 92, 41));
        btnExitAddMember->setMinimumSize(QSize(92, 0));
        btnExitAddMember->setStyleSheet(QString::fromUtf8("/*-----QPushButton-----*/\n"
"QPushButton\n"
"{\n"
"	background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 rgba(124, 0, 0, 255), stop:0.935 rgba(170, 0, 0, 255));\n"
"color: white;\n"
"font: 8pt \"Century Gothic\";\n"
"min-width: 80px;\n"
"border-style: solid;\n"
...
"}"));
    ...
    void retranslateUi(QDialog *addmember)
    {
        ...
        btnExitAddMember->setText(QCoreApplication::translate("addmember", "X", nullptr));
