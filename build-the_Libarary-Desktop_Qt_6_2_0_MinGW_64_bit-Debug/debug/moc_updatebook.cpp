...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_updatebook_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_updatebook_t qt_meta_stringdata_updatebook = {
    {
QT_MOC_LITERAL(0, 10) // "updatebook"
...
const QMetaObject updatebook::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_updatebook.offsetsAndSize,
    qt_meta_data_updatebook,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_updatebook_t
, QtPrivate::TypeAndForceComplete<updatebook, std::true_type>
